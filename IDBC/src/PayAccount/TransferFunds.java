...
public class TransferFunds
{
    public static void transferFunds()
    {
        ...
        System.out.print("Do you want to transfer into SAVINGS ACCOUNT [Y/N]? : ");
        ...
        if(userChoice == 'Y')
        {
            try
            {
                ...
                String getBeneBalanceQuery = "select balance from savingsaccount where AccountNumber = ?";
                ...
                if(balance > 0 && deposit < balance)
                {
                    ...
                    String query3 = "insert into PayTransactions values(?,?,?,?,?,?)";
                    ...
                    updateStmt.setInt(5,deposit);
                    updateStmt.setTime(6, Time.valueOf(java.time.LocalTime.now()));
                    updateStmt.executeUpdate();


                    System.out.println("Amount Deposited Successfully.");
                    SavingsAccount.AccountDetailsAndTransactions.showTransactionDetails(transactionid,connect);
                }
                else
