...
public class AccountDetailsAndTransactions
{
    ...
    public static void showNewAccountDetails(Long accountNumber, String accountHolder)
    {
        ...
        System.out.println("Account Type   : Pay");
    }
    ...
    {
        String query = "select paytransactions.*,payaccount.balance from paytransactions join payaccount on(paytransactions.accountnumber = payaccount.accountnumber) where transactionid = ?";
    ...
    public static void showBalance()
    {
        ...
        try
        {
            ...
            String query = "select accountnumber, accountholder, balance from payaccount where accountnumber = ?";
            PreparedStatement stmt = connect.prepareStatement(query);
    ...
    public static void showLastTransactionDetails()
    {
        ...
        System.out.print("Please enter the Account Number : ");
        long accountNumber = scan.nextLong();
        String query = "select * from paytransactions where accountnumber = ? order by transactiontime desc limit 5 ";
        try
        {
            Connection connect = EstablishConnection.establish();
            PreparedStatement stmt = connect.prepareStatement(query);
